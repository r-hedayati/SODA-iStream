...
if __name__ == '__main__':
    ...
    #print("sleep....")
    #sleep(30)
    os.system('ovs-vsctl add-port s1 grec -- set interface grec type=gre options:remote_ip=172.17.0.4')
    #sleep(5)
    hosts[0].cmdPrint('ifconfig h1-eth0 mtu 1400 up')
    #sleep(5)
    #hosts[0].cmdPrint('python3 -m dash_emulator.main http://10.0.0.4/live.mpd --output /root/result/h1 -y &')
    #hosts[1].cmdPrint('python3 -m dash_emulator.main http://10.0.0.4/live.mpd --output /root/result/h2 -y &')
    #hosts[2].cmdPrint('python3 -m dash_emulator.main http://10.0.0.5/live.mpd --output /root/result/h3 -y &')
